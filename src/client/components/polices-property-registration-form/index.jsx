        ...
        return (
            <Fragment>
                <Header
                    ...
                    className="required"
                >
                    Cancellations. Can your guests cancel their booking for
                    free?
                </Header>
                <br />
                <Field
    ...
    render() {
        ...
        return (
            <Form id="policesPropertyRegistrationForm" onSubmit={handleSubmit}>
                <Container>{this.renderCancellationCard()}</Container>
                <Container>{this.renderCheckInCheckOutCard()}</Container>
                <Button
                    color="teal"
                    fluid
