...
class RoomItems extends Component {
    renderBed(bed) {
        return (
            <Fragment>
                <Grid.Row columns={2}>
                    <Grid.Column>{bed.bedType.name}</Grid.Column>
                    <Grid.Column>{bed.count}</Grid.Column>
                </Grid.Row>
                <Divider />
            </Fragment>
        );
        ...
        return (
            <Segment>
                <Grid centered>
                    ...
                    >
                        <Grid.Column>Room Type</Grid.Column>
                        <Grid.Column>Amount</Grid.Column>
                        <Grid.Column>Price</Grid.Column>
                        <Grid.Column>Area</Grid.Column>
                    ...
                    <Grid.Row columns={5}>
                        ...
                        <Grid.Column>{room.amount}</Grid.Column>
                        <Grid.Column>{room.price}</Grid.Column>
                        <Grid.Column>{room.area}</Grid.Column>
                        <Grid.Column>
                    ...
                    <Grid.Row columns={2} style={{ background: "whitesmoke" }}>
                        <Grid.Column>Bed Type</Grid.Column>
                        <Grid.Column>Total</Grid.Column>
                    </Grid.Row>
                    {room.bedInRooms &&
                        room.bedInRooms.map(x => this.renderBed(x))}
        ...
        return rooms && rooms.length !== 0 ? (
            ...
            <Container style={{ padding: "1rem 0" }}>
                <p className="default-text">
                    You have not added any room to your property. Please, add
                    rooms with bed description and other info
                </p>
            </Container>
        );
    }
