    ...
    return (
        <Fragment>
            <Card style={{ width: "1000px" }}>
                <ButtonWithCheckbox
                    contentTitle="Room amenities"
                    fieldsDataList={[
                        { label: "Clothes rack", name: "Clothes rack" }
                    ]}
                />
                <ButtonWithCheckbox
                ...
                />
                <ButtonWithCheckbox
                    contentTitle="Media & Technology"
                    fieldsDataList={[{ label: "Computer", name: "Computer" }]}
                />
                <ButtonWithCheckbox
                    contentTitle="Food & Drink"
                    fieldsDataList={[
                        { label: "Dining area", name: "Dining area" }
                    ]}
                />
                <ButtonWithCheckbox
                    contentTitle="Services & Extras"
                    fieldsDataList={[
                        {
                ...
                />
                <ButtonWithCheckbox
                    contentTitle="Outdoor & View"
                    fieldsDataList={[{ label: "Balcony", name: "Balcony" }]}
                />
                <ButtonWithCheckbox
                    contentTitle="Building Characteristics"
                    fieldsDataList={[{ label: "Detached", name: "Detached" }]}
                />
                <ButtonWithCheckbox
                    contentTitle="Entertainment & Family Services"
                    fieldsDataList={[
                        {
