...
import { Button, Card, Form, Container, Header, Icon } from "semantic-ui-react";
    ...
    render() {
        ...
        return (
            <Form onSubmit={handleSubmit} id="paymentPropertyRegistartionForm">
                <Container>{this.renderPaymentTypeCard()}</Container>
                <Container>{this.renderFeeCard()}</Container>
