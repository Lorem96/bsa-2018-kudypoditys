...
accommodationRule
    ...
    .put((req, res) => {
        accommodationRuleService
            .updateAccommodationRule(req.params.id, req.body)
            .then(accommodationRule => {
                res.send(accommodationRule);
            })
            .catch(err => {
    ...
    .get((req, res) => {
        accommodationRuleService
            .getAccommodationRuleById(req.params.id)
            .then(accommodationRule => {
                res.send(accommodationRule);
            })
            .catch(err => {
    ...
    .delete((req, res) => {
        accommodationRuleService
            .deleteAccommodationRule(req.params.id)
            .then(accommodationRule => {
                res.send(accommodationRule);
            })
            .catch(err => {
