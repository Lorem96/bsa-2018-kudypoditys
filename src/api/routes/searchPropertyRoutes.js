        ...
        .then(
            resp => {
                ...
                let filter = {
                    ...
                    full_body_massage: req.query.Full_body_massage
                        ? req.query.Full_body_massage
                        : "",
                    daily_maid_service: req.query.Daily_maid_service
                        ? req.query.Daily_maid_service
                        : "",
                    laundry: req.query.Laundry ? req.query.Laundry : "",
                    walking_tours: req.query.Walking_tours
                        ? req.query.Walking_tours
                        : "",
                    live_music_performance: req.query.Live_music_performance
                        ? req.query.Live_music_performance
                        : "",
                    live_sport_events: req.query.Live_sport_events
                        ? req.query.Live_sport_events
                        : "",
                    themed_dinner_nights: req.query.Themed_dinner_nights
                        ? req.query.Themed_dinner_nights
                        : "",
                    movie_nights: req.query.Movie_nights
                        ? req.query.Movie_nights
                        : "",
